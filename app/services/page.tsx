    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-16">
      <div className="mb-10 grid gap-8 md:grid-cols-2">
        <div>
          ...
          <Link
            href="/contact"
            className="mt-6 inline-block rounded-full border border-zinc-300 px-6 py-3 text-sm font-semibold text-zinc-800 transition hover:border-red-500 hover:text-red-500"
          >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <article className="rounded-2xl border border-zinc-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-blue-800">Infrastructure & Civil Works</h2>
        ...
        <article className="rounded-2xl border border-zinc-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-blue-800">Plumbing Works</h2>
          <p className="mt-4 text-sm font-semibold text-zinc-900">External Plumbing</p>
          <ul className="mt-2 space-y-2 text-sm text-zinc-600">
            {externalPlumbing.map((service) => (
              <li key={service}>• {service}</li>
            ))}
          </ul>
          <p className="mt-4 text-sm font-semibold text-zinc-900">Internal Plumbing</p>
          <ul className="mt-2 space-y-2 text-sm text-zinc-600">
        ...
        <article className="rounded-2xl border border-zinc-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-blue-800">Fire Fighting Works</h2>
          <ul className="mt-4 space-y-2 text-sm text-zinc-600">
